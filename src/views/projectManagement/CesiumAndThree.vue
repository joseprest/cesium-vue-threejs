...
export default {
  ...
  mounted() {
    ...
    function init3DObject() {
      ...
      // loader.load("models/Forklift.fbx", function(fbx) {
      //   const scaleSize = 0.5;
      //   fbx.scale.set(scaleSize, scaleSize, scaleSize);
      //   fbx.position.x -= 500.0;
      ...
      // fbxLoader.load("models/SambaDancing.fbx", function(object) {
      //   const scaleSize = 0.5;
      ...
      // // 加载一个gltf文件，展示一只狗和一个人
      // const loader = new THREE.GLTFLoader()
      // loader.load('models/example.glb', function (gltf) {
      //     const scaleSize = 150
      //     gltf.scene.position.x += 150.0
      ...
      // // 加载一个obj文件及mtl，展示一块城市
      // const cityLoader = new THREE.MTLLoader().setPath('models/')
      // cityLoader.load('city.mtl', function (materials) {
      //     const loaderOBJ = new THREE.OBJLoader().setPath('models/')
      //     loaderOBJ.setMaterials(materials)
      //     loaderOBJ.load('city.obj', function (obj) {
      //         const scaleSize = 3
      //         obj.scale.set(scaleSize, scaleSize, scaleSize)
      //         obj.position.x -= 1000.0
      //         obj.rotation.x = Math.PI / 2
      ...
      //         if ( xhr.lengthComputable ) {
      //             var percentComplete = xhr.loaded / xhr.total * 100;
      //             console.log( Math.round(percentComplete, 2) + '% city---downloaded' );
      //         }
      //     }, function ( xhr ) {
      //         console.error(xhr, "onError")
      //     })
      ...
      // // 加载obj文件及其mtl、png，展示一个兵马俑
      // const soldierLoader = new MTLLoader().setPath("models/");
      // soldierLoader.load("4.mtl", function(materials) {
      //   const loaderOBJ = new OBJLoader().setPath("models/");
      //   loaderOBJ.setMaterials(materials);
